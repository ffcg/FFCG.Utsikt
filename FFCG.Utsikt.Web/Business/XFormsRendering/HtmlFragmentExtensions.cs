...
namespace FFCG.Utsikt.Web.Business.XFormsRendering
{
    /// <summary>
    ...
    public static class HtmlFragmentExtensions
    {
        ...
        public static void RenderCustomXForm(this HtmlHelper htmlHelper, XForm xform, XFormParameters parameters)
        {
            ...
            htmlHelper.RenderPartial(string.Format("~/Views/Shared/DisplayTemplates/{0}.cshtml",typeof(XForm).Name), xform);
        }
